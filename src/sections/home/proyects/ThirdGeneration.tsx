    ...
    >
      ...
      <Scrollbar>
        <Typography variant="h3" textAlign="center">
          { translate('generationsPlan.titleThirdGeneration') }
        </Typography>
        <Grid container spacing={5} mt="10px" direction={'column'} sx={{textAlign:"justify"}}>
          <Grid item xs={12}>
            <Typography variant="subtitle1">{translate('generationsPlan.thirdGenerationContent0')}</Typography>
            <Typography variant="body2" component="p">
              {translate('generationsPlan.thirdGenerationContent1')}
            </Typography>
          </Grid>
          <Grid item xs={12}>
            <Typography variant="subtitle1">
              {translate('generationsPlan.thirdGenerationContent2')}
            </Typography>
            <Typography variant="body2" component="p">
              {translate('generationsPlan.thirdGenerationContent3')}
            </Typography>
          </Grid>
        </Grid>
      </Scrollbar>
